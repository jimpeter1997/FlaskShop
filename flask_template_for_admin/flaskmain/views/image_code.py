...
# @flask_views.route('/get_codes_image/<string:image_uuid>')
@flask_views.route("/get_codes_image/<re(r'[0-9a-zA-Z]{36}.png'):url_image_uuid>")
def get_code_image(url_image_uuid):
    """
    获取图片验证码链接
    ...
    :return: 正确情况下，返回验证码图片
             异常情况下，返回json数据
    """
    # print('url_image_uuid = ', url_image_uuid)
    image_uuid = re.findall('([0-9a-zA-Z]{36}).png', url_image_uuid)[0]
